...
def getOriginalItems():
    file = open(f"{current_app.root_path}/static/ml_data/movie_info.csv", encoding="ISO-8859-1")
...
def covertMovieDataWithOverview():
    ...
    path = f"{rootPath}/flaskr/static/ml_data/movie_info_new.csv"
    ...
    for line in final_lines:
        file = open(f"{rootPath}/flaskr/static/ml_data/movie_info_new_2.csv", "a")
        file.write(line)
        file.close()

    rootPath = os.path.abspath(os.getcwd())
    path = f"{rootPath}/flaskr/static/ml_data/movie_info_new_3.csv"
    ...
    for line in lines:
        file = open(f"{rootPath}/flaskr/static/ml_data/movie_info_new_3.csv", "a")
        file.write(line)
        file.close()